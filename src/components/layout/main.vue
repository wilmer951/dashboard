  ...
  <div class="flex h-screen bg-gray-100 font-sans dark:bg-gray-900">
    ...
    >
      <div class="flex h-full flex-col">
        ...
        <nav class="flex-1 space-y-2 overflow-y-auto p-4">
          ...
          <router-link to="/users" class="flex items-center rounded-lg px-4 py-2.5 text-gray-600 transition-colors duration-200 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
    ...
    <div class="flex flex-1 flex-col">
      ...
      <header class="flex h-16 flex-shrink-0 items-center justify-between bg-white px-6 shadow-md dark:bg-gray-800">
        ...
        <div>
          <span class="text-gray-700 dark:text-gray-300">Bienvenido</span>
        </div>
      </header>
